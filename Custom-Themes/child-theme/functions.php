...
function divi__child_theme_enqueue_styles() {
  wp_enqueue_style( 'parent-style', get_template_directory_uri() . '/style.css' );
    ...
    $custom_css=filemtime(__DIR__.'/parent-style.min.css');
    wp_enqueue_style( 'child-style_custom',get_stylesheet_directory_uri() . '/parent-style.min.css',NULL,$custom_css);

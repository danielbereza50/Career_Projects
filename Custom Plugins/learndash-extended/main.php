...
/*
    Plugin Name: 
    Plugin URI:  
    Description: Allows site users to search for a course on a wordpress page and other functionalities.
    Version:     100.0.0
    Author:      
    Author URI: 
    License:     GPL2
...
include __DIR__.'/includes/class-meta-box.php';
...
function my_custom_script_load(){
	...
	wp_enqueue_script(
		'main-js',
		plugins_url('public/js/functions.js',__FILE__ ),
		array( 'jquery' )
	);

...
If (CStr(Request("MM_update")) = "form1") Then
  If (Not MM_abortEdit) Then
    ...
    MM_editCmd.CommandText = "UPDATE tblMembers SET FirstName = ?, LastName = ?, Email = ?, HomePhone = ?, CellPhone = ?, Address = ?, City = ?, [State] = ?, Zip = ?, MembType = ?, MembLevel = ?, Cameras = ?, ShowAll = ?, ShowEmail = ?, ShowHomePhone = ?, ShowCellPhone = ?, ShowAddress = ?, ShowCamera = ?, ShowNameOnly = ?, Pass = ?, RenewDate = ? WHERE primkey = ?" 
    ...
    MM_editCmd.Parameters.Append MM_editCmd.CreateParameter("param20", 202, 1, 50, Request.Form("Pass")) ' adVarWChar
	MM_editCmd.Parameters.Append MM_editCmd.CreateParameter("param21", 135, 1, -1, Request.Form("RenewDate")) ' adDBTimeStamp
...
oMail.Bcc = "webwizard@domain.org"
'oMail.To = "jeff@domain.org"

oMail.Subject = "Charlotte Camera Club Membership RENEWAL"
...
<input type="hidden" name="item_name" value="Charlotte Camera Club Returning Membership">
<input type="hidden" name="amount" value="46.50">
...
<input type="hidden" name="return" value="http://charlottecameraclub.com">
<input type="hidden" name="cancel_return" value="http://charlottecameraclub.com/Renew.asp">
